...
using WMS.ResponseParser_1_3_0;
using WMS.Common;
...
{
    [TestClass]
    public class ResponseParser_1_3_0Tests
    {
        [TestMethod]
        public void ParseMRCOGResponseTest ()
        {
            ResponseParser_1_3_0 parser = new ResponseParser_1_3_0();
            GetCapabilitiesResponse response = parser.parseResponse(WMSResponseParser_1_3_0Tests.TestResources.RGIS_MRCOG_GetCapabilities_1_3_0);
            Assert.AreEqual("1.3.0", response.Version);
            Assert.AreEqual("WMS", response.Service.Name);
            ...
            Assert.AreEqual(5000, response.Service.MaxHeight);
            Assert.AreEqual(5000, response.Service.MaxWidth);
        }
        ...
        public void ParseException()
        {
            ...
            try
            {
                parser.parseException(TestResources.example_exception_1_3_0);
            }
