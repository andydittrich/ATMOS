...
namespace UsgsWaterData
{
    public class CountyCode
    {
        ...
        {
            return (from pair in countyCodes where pair.Value == countyName select pair.Key).FirstOrDefault();
        }

        private static Dictionary<string, string> countyCodes = new Dictionary<string, string>
        { 
            ...
            { "02201", "Prince Of Wales-Outer Ketchikan Div Coun" },
            { "02220", "City & Borough Of Sitka" },
            { "02232", "Skagway-Hoonah-Angoon Division" },
            { "02240", "Southeast Fairbanks Division" },
            { "02261", "Valdez-Cordova Division" },
            { "02270", "Wade Hampton Division" },
            { "02280", "Wrangell-Petersburg Division" },
            { "02282", "City & Borough Of Yakutat" },
            { "02290", "Yukon-Koyukuk Division" },
            { "04001", "Apache County" },
            ...
            { "17037", "De Kalb County" },
            { "17039", "De Witt County" },
            { "17041", "Douglas County" },
            { "17043", "Du Page County" },
            { "17045", "Edgar County" },
            ...
            { "30113", "Yellowstone Natl Park - Part County" },
            { "31001", "Adams County" },
            ...
            { "56045", "Weston County" },
            { "60010", "Tutuila County" },
            { "60020", "Manua Islands County" },
            { "60030", "Rose Island County" },
            { "60040", "Swains Island County" },
            { "60050", "Aunuu County" },
            { "64005", "Kosrae County" },
            { "64040", "Pohnpei County" },
            { "64050", "Chuuk County" },
            { "64060", "Yap County" },
            { "66010", "Guam" },
            { "68007", "Ailinginae County" },
            { "68010", "Ailinglaplap County" },
            { "68030", "Ailuk County" },
            { "68040", "Arno County" },
            { "68050", "Aur County" },
            { "68060", "Bikar County" },
            ...
            { "68073", "Bokak County" },
            { "68080", "Ebon County" },
            { "68090", "Enewetak County" },
            { "68100", "Erikub County" },
            { "68110", "Jabat County" },
            { "68120", "Jaluit County" },
            { "68130", "Jemo Island County" },
            { "68140", "Kili County" },
            { "68150", "Kwajalein County" },
            { "68160", "Lae County" },
            { "68170", "Lib County" },
            { "68180", "Likiep County" },
            { "68190", "Majuro County" },
            { "68300", "Maloelap County" },
            { "68310", "Mejit County" },
            { "68320", "Mili County" },
            { "68330", "Namorik County" },
            { "68340", "Namu County" },
            { "68350", "Rongelap County" },
            { "68360", "Rongrik County" },
            { "68385", "Toke County" },
            { "68390", "Ujae County" },
            { "68400", "Ujelang County" },
            { "68410", "Utrik County" },
            { "68420", "Wotho County" },
            { "68430", "Wotje County" },
            { "69085", "Northern Islands County" },
            { "69100", "Rota County" },
            { "69110", "Saipan County" },
            { "69120", "Tinian County" },
            { "70002", "Aimeliik County" },
            { "70004", "Airai County" },
            { "70010", "Angaur County" },
            { "70100", "Kayangel County" },
            { "70150", "Koror County" },
            { "70212", "Melekeiok County" },
            { "70214", "Ngaraard County" },
            { "70218", "Ngarchelong County" },
            { "70222", "Ngardmau County" },
            { "70223", "Ngaremlengui County" },
            { "70224", "Ngatpang County" },
            { "70226", "Ngchesar County" },
            { "70228", "Ngiwal County" },
            { "70300", "Palau-Unorg. County" },
            { "70350", "Peleiu County" },
            { "70370", "Sonsorol County" },
            { "70380", "Tobi County" },
            ...
            { "78010", "St Croix County" },
            { "78020", "St John County" },
            { "78030", "St Thomas County" }
        };
    }
}